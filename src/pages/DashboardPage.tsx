...
type ActivityType = "practice" | "test" | "achievement" | "feedback"
    ...
    const activities: Activity[] = [
        {
            ...
            description:
                "You completed 5 Read Aloud exercises with an average score of 75%.",
            score: 75,
            skillType: "Speaking",
        },
        {
            ...
            description:
                "You completed Mock Test #3 with an overall score of 68.",
            score: 68,
        },
        {
            id: 3,
            ...
            description:
                'You earned the "Consistent Learner" badge for practicing 7 days in a row.',
        },
        {
            id: 4,
            type: "practice",
            ...
            description:
                "You completed 3 Summarize Written Text exercises with an average score of 62%.",
            score: 62,
            skillType: "Writing",
        },
    ]
    ...
    const recommendedPractices: Practice[] = [
        {
            ...
            recommended: true,
            description:
                "Improve your read aloud skills with these carefully selected passages focused on complex vocabulary and scientific topics.",
        },
        {
            id: 2,
            ...
            recommended: true,
            description:
                "Challenge yourself with advanced fill in the blanks exercises targeting academic vocabulary and contextual understanding.",
        },
        {
            id: 3,
            ...
            recommended: false,
            description:
                "Practice condensing complex passages into concise summaries within the word limit while maintaining key ideas.",
        },
        {
            id: 4,
            ...
            recommended: false,
            description:
                "Practice repeating sentences of varying length and complexity to improve your speaking accuracy and memory.",
        },
    ]
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="mb-8">
                    <h1 className="text-2xl font-bold text-gray-900">
                        Welcome back,{" "}
                        {user.username || user.full_name || "Student"}!
                    </h1>
                    <p className="text-gray-600 mt-1">
                        Here's an overview of your PTE preparation progress.
                    </p>
                </div>
