...
const ReadAloudListPage = () => {
    ...
    const handleLessonSelect = (lesson: ReadAloudLesson) => {
        navigate(`/practice/speaking/read-aloud/${lesson.id}`, { state: { lesson } })
    }
        ...
        <div className="bg-gray-50 pt-16 pb-24">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex items-center mb-8">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold text-gray-900">Read Aloud Practice</h1>
                        <p className="text-gray-600 mt-1">
                            Improve your pronunciation and fluency with these carefully selected passages
                        </p>
                    </div>
                </div>
                    ...
                    <div className="flex flex-wrap gap-4">
                        ...
                        <div className="flex items-end">
                            <label className="inline-flex items-center">
                                ...
                                />
                                <span className="ml-2 text-sm text-gray-700">Show completed only</span>
                            </label>
                        </div>
                    </div>
                </div>
